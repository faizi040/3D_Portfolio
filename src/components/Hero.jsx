  ...
  return (
    <section className="relative h-screen w-full mx-auto">
      ...
      <div className={`${styles.paddingX} absolute inset-0 top-[80px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, i'm<span className="text-[#915eff]">  Faiz</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>I develop user interfaces and web applications</p>
        </div>
      </div>
      <ComputerCanvas />
      <div className="absolute xs:bottom-[75px] bottom-32 w-full flex justify-center items-center">
        <a href="#about">
